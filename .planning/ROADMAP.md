...
- [ ] **Phase 1: Tier Legibility** - Every registered component gets an explicit tier, and a design-intent doc states each tier's contract and litmus
...
|-------|----------------|--------|-----------|
| 1. Tier Legibility | 0/TBD | Not started | - |
