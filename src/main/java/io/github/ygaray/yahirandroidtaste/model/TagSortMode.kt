...
/**
 * Canonical global tag sort mode (TSORT-01), consumed by [io.github.ygaray.yahirandroidtaste.component.SortControl]
 ...
 *
 * @property label Display copy shown in [io.github.ygaray.yahirandroidtaste.component.SortControl]'s dropdown menu.
 */
