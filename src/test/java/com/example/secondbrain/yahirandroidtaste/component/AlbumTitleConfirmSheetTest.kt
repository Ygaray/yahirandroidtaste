...
class AlbumTitleConfirmSheetTest {
    ...
    fun `resolves absolute first path unchanged`() {
        val absolutePath = "/data/user/0/com.example.secondbrain/cache/album_gallery_x.jpg"
    ...
    fun `ignores all but the first path`() {
        val first = "/data/user/0/com.example.secondbrain/cache/first.jpg"
        val second = "/data/user/0/com.example.secondbrain/cache/second.jpg"
